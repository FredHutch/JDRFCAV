...
## GEO website:
library(GEOquery)
gse_web <- getGEO("GSE781",GSEMatrix=FALSE) # active once released

## or, by 5 SuperSeries:
GSE131523 # Affymetrix Cohort 0
GSE131524 # Affymetrix Cohort 2
GSE131525 # RNA-Seq Cohort 0 Cell Sorted
GSE131526 # RNA-Seq Cohort 0 WB
GSE131527 # RNA-Seq Cohort 2 Cell Sorted

# gse_tar <- getGEO(filename="/Users/dberel/Desktop/GSE131528_RAW.tar") 
head(Meta(gse))
names(GSMList(gse))
