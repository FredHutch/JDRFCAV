...
unmaskFile <- "GEO/RNAseq WB/T1DAL_unmask.csv"
...
demoDat <- read_excel("GEO/RNAseq WB/20170110 ITN clinical and demographic.xlsx")
...
genebcvFile <- "GEO/RNAseq WB/CAV-Cohort-0-RNAseq-WholeBlood-HighCVAnalytes_20170124b.csv"
