---
title: 'P133-1: CAV Cohort 2 RNAseq - B Cells - QC verification'
...
genecvFile <- "../CAV-Cohort-0-RNASeq-CellSubsets/data/CAV-Cohort-0-RNAseq-CellSubsets-Bcell-HighCVAnalytes_20170125a.csv"
...
curDGE <- curDGE[,annotDat$cell_type=="Bcell"]
annotDat <- annotDat[annotDat$cell_type=="Bcell",]
dim(curDGE)
...
## Correcting the Horsehose effect

```{r}

ggplot(melt(curDGE$E[21:40,]),
       aes(x=value,
           color=Var1)) + 
  geom_line(stat="density", show.legend = F) + facet_wrap(~Var1, ncol=5) 
...
# save(curDGE, file = "data/CAV-Cohort-2-RNAseq_Bcell_data_20170224a.RData")
