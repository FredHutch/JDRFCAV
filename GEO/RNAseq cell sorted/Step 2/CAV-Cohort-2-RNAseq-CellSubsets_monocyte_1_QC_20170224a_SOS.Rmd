---
title: 'P133-1: CAV Cohort 2 RNAseq - Monocyte - QC verification'
...
genecvFile <- "../CAV-Cohort-0-RNASeq-CellSubsets/data/CAV-Cohort-0-RNAseq-CellSubsets-monocyte-HighCVAnalytes_20170125a.csv"
...
curDGE <- curDGE[,annotDat$cell_type=="monocyte"]
annotDat <- annotDat[annotDat$cell_type=="monocyte",]
dim(curDGE)
...
save(curDGE, file = "data/CAV-Cohort-2-RNAseq_monocyte_data_20170224a.RData")
