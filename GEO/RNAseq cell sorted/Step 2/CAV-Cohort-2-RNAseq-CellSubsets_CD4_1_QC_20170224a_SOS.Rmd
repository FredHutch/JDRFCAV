---
title: 'P133-1: CAV Cohort 2 RNAseq - CD4+ T Cells - QC verification'
...
genecvFile <- "../CAV-Cohort-0-RNASeq-CellSubsets/data/CAV-Cohort-0-RNAseq-CellSubsets-CD4-HighCVAnalytes_20170125a.csv"
...
curDGE <- curDGE[,annotDat$cell_type=="CD4"]
annotDat <- annotDat[annotDat$cell_type=="CD4",]
dim(curDGE)
...
save(curDGE, file = "data/CAV-Cohort-2-RNAseq_CD4_data_20170224a.RData")
